...
console.log(ratingReview([1, 5, 5])); // [ 'fullstar', 'fullStar', 'fullStar', 'halfStar', 'emptyStar']
console.log(ratingReview([5, 5, 5])); // [ 'fullstar', 'fullStar', 'fullStar', 'fullStar', 'fullStar']
console.log(ratingReview([1, 2, 3, 4, 5])); // [ 'fullStar', 'fullStar', 'fullStar', 'emptyStar', 'emptyStar' ]
console.log(ratingReview([3, 3, 3, 4, 5])); // [ 'fullStar', 'fullStar', 'fullStar', 'halfStar', 'emptyStar' ]
